...
⠀⠀⠀⠀⠀⠈⠻⠿⠿⠓⠄⠤⠘⠉⠙⠤⢀⠾⠿⣿⠟⠋  
        ...
        <div id="about_hb" className="about">
          ...
          <p className="text-sm sm:text-base leading-relaxed">
            Janet Yellen is Biden’s employee-of-the-year. In a year when the US
            government was facing a near-record budget deficit while long-term
            interest rates were blowing out, Yellen devised an ingenious way to
            secure trillions of dollars in funding for the government without
            breaking the US long-term debt market. This issue describes Yellen’s
            Trillion-Dollar Magic Trick.
          </p>
        </div>
      </div>
    </section>
